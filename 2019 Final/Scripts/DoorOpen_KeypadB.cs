...
public class DoorOpen_KeypadB : MonoBehaviour
{
    ...
    public static bool nearDoorB = false; // says if near door
    ...
    {
        if (collision.CompareTag("Player") && open == false && PlayerScoreFixRobot.doorUnlockedB == true) // only works after getting close, hasn't been opened, and robots fixed
        {
            speechBubble.SetActive(true); // tells player to press the buttons 
            Debug.Log("Near Door1"); // for testing
            nearDoorB = true; // says door display on
        }
        else if (collision.CompareTag("Player") && open == false && PlayerScoreFixRobot.doorUnlockedB == false) // locked
        {
    ...
    void OnTriggerExit(Collider collision)
    {
        ...
        {
            nearDoorB = false; // not in volume
            speechBubble.SetActive(false);
            PlayerScoreFixRobot.doorText = false;
            Debug.Log("left door end volume");
            if (open == false && PlayerScoreFixRobot.doorUnlockedB == false)
            {
    ...
    void Update()
    {
        if (Input.GetButtonDown("Fire1") && nearDoorB == true && open == false && PlayerScoreFixRobot.doorUnlockedB == true && interfaceOff == true)
        ...
        else if (Input.GetButtonDown("Fire1") && nearDoorB == true && open == false && PlayerScoreFixRobot.doorUnlockedB == false)
        { //if the player presses the mouse button but door is locked
            ...
            nearDoorB = false; // keeps you from pressing and hearing sound multiple times
        }
        if (Input.GetKeyDown(KeyCode.F) && nearDoorB == true && open == false && PlayerScoreFixRobot.doorUnlockedB == true && interfaceOff == false)
        {
            Debug.Log("Key 1");
            rightkey1 = true;
        ...
        if (Input.GetKeyDown(KeyCode.S) && nearDoorB == true && open == false && PlayerScoreFixRobot.doorUnlockedB == true && interfaceOff == false && rightkey1 == true)
        {
            Debug.Log("Key 2");
            rightkey2 = true;
        ...
        if (Input.GetKeyDown(KeyCode.A) && nearDoorB == true && open == false && PlayerScoreFixRobot.doorUnlockedB == true && interfaceOff == false && rightkey1 == true && rightkey2==true)
        {
            Debug.Log("Key 3");
            rightkey3 = true;
