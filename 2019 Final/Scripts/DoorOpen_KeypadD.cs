...
public class DoorOpen_KeypadD : MonoBehaviour
{
    ...
    public static bool nearDoorD = false; // says if near door
    ...
    public void OnTriggerEnter(Collider collision)
    {
        if (collision.CompareTag("Player") && open == false && PlayerScoreFixRobot.doorUnlocked == true) // only works after getting close, hasn't been opened, and robots fixed
        {
            ...
            nearDoorD = true; // says door display on
        }
    ...
    void Update()
    {
        if (Input.GetButtonDown("Fire1") && nearDoorD == true && open == false && PlayerScoreFixRobot.doorUnlocked == true && interfaceOff == true)
        ...
        else if (Input.GetButtonDown("Fire1") && nearDoorD == true && open == false && PlayerScoreFixRobot.doorUnlocked == false)
        { //if the player presses the mouse button but door is locked
            ...
            nearDoorD = false; // keeps you from pressing and hearing sound multiple times
        }
        if (Input.GetKeyDown(KeyCode.S) && nearDoorD == true && open == false && PlayerScoreFixRobot.doorUnlocked == true && interfaceOff == false)
        {
            Debug.Log("Key 1");
            rightkey1 = true;
        ...
        if (Input.GetKeyDown(KeyCode.O) && nearDoorD == true && open == false && PlayerScoreFixRobot.doorUnlocked == true && interfaceOff == false && rightkey1 == true)
        {
            Debug.Log("Key 2");
            rightkey2 = true;
        ...
        if (Input.GetKeyDown(KeyCode.M) && nearDoorD == true && open == false && PlayerScoreFixRobot.doorUnlocked == true && interfaceOff == false && rightkey1 == true && rightkey2==true)
        {
            Debug.Log("Key 3");
            rightkey3 = true;
