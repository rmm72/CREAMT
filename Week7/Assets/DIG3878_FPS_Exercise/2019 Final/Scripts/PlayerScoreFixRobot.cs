...
public class PlayerScoreFixRobot : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (robotCount >= botsToFix && DoorOpen_KeypadA.nearDDoor == false) // if have enough bots now door is unlocked
        {
        ...
        else if (robotCount >= botsToFix && DoorOpen_KeypadA.nearDDoor == true) // if have enough bots now door is unlocked
        {
